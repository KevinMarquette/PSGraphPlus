#
# Module manifest for module 'PSGraphPlus'
#
...
@{
    ...
    GUID              = '0a6ede59-061f-4e92-ac5d-634a217fc62d'
    ...
    Description       = 'Utility module that makes use of PSGraph'
    ...
    FunctionsToExport = @('Show-AstCommandGraph', 'Show-AstGraph', 'Show-GitGraph', 'Show-NetworkConnectionGraph', 'Show-ProcessConnectionGraph', 'Show-ServiceDependencyGraph')
